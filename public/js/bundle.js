...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _reactDom.render)(_react2.default.createElement(_editor2.default, null), document.getElementById('editor-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _connectToStores = __webpack_require__(159);
	...
	var _editor3 = __webpack_require__(176);
	...
	var _renderer = __webpack_require__(177);
	...
	var Editor = function (_Component) {
	    ...
	    _createClass(Editor, [{
	        ...
	        value: function onKeyUp(e) {
	            _editor4.default.keyUp(e);
	        }
	    }, {
	        key: 'onKeyPress',
	        value: function onKeyPress(e) {
	            _editor4.default.keyPress(e);
	        }
	    }, {
	        key: 'onFocus',
	        value: function onFocus() {
	            _editor4.default.focus();
	        }
	    }, {
	        key: 'onBlur',
	        value: function onBlur() {
	            _editor4.default.blur();
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            // only add the cursor on render
	            var html = this.props.html + _renderer2.default.cursor();

	            return _react2.default.createElement(
	                'div',
	                { id: 'editor', className: (0, _classnames2.default)({ active: this.props.active }) },
	        ...
	        value: function getPropsFromStores() {
	            return _editor2.default.getState();
	        }
	    }]);
	...
	exports.default = (0, _connectToStores2.default)(Editor);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditorStore = function () {
	    function EditorStore() {
	        ...
	        this.bindActions(_editor2.default);
	    ...
	    _createClass(EditorStore, [{
	        ...
	        value: function keyUp(e) {
	            this.state.html = _renderer2.default.keyUp(this.state.html, e);
	        }
	    }, {
	        key: 'keyPress',
	        value: function keyPress(e) {
	            this.state.html = _renderer2.default.keyPress(this.state.html, e);
	        }
	    }, {
	        key: 'focus',
	...
	exports.default = _alt2.default.createStore(EditorStore, 'EditorStore');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _functions = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isPromise = __webpack_require__(175);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _alt2.default.generateActions('keyUp', 'keyPress', 'focus', 'blur');
...
/***/ function(module, exports) {
	...
	var ENTER_HTML = '<br />';
	var ENTER_LAST_CHAR = ENTER_HTML.substring(ENTER_HTML.length - 1, ENTER_HTML.length);

	var CURSOR_HTML = '<span id="cursor"></span>';

	/**
	 * Are we dealing with the backspace key?
	 */
	var isBackspace = function isBackspace(code) {
	 ...
	 */
	var isEnter = function isEnter(code) {
	    return code === ENTER;
	};
	 ...
	 */
	var ignore = function ignore(code) {
	    return code === ENTER;
	};
	 ...
	 */
	var removeLast = function removeLast(current) {
	    var length = current.length;
	    var last = current.substring(length - 1, length);
	...
	var Renderer = function () {
	    ...
	    _createClass(Renderer, [{
	         ...
	         */
	        value: function keyUp(current, e) {
	        ...
	        key: 'keyPress',
	        value: function keyPress(current, e) {
	            if (ignore(e.which)) {
	                return current;
	            }
